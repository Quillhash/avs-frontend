...
export default function AuditedContract() {
  ...
  //   "auditReport",
  //   auditReport,
  //   Object.keys(auditReport)?.[0],
  //   JSON.parse(Object.keys(auditReport)?.[0])
  // )
        ...
        <div className="flex flex-col gap-4">
            ...
            <div className="flex w-full flex-col items-center justify-center gap-2 rounded-xl bg-primary-foreground/5 px-5 py-4">
              ...
              <div className="flex flex-row items-center justify-center gap-2">
                <Image
                  ...
                  alt={"Risk Score"}
                />
                <h4 className="text-3xl font-bold">98.32%</h4>
              </div>
            </div>
          ...
          <div className="rounded-xl bg-primary-foreground/5 px-5 py-4">
            ...
            {/* <ul className="max-h-[400px] overflow-auto">
              {data?.files.map((directory: any, index) => (
                <Directory
                  key={index}
                  data={directory}
                  openFileIds={openFileIds}
                  containsFileId={containsFileId}
                  vulnerabilities={vulnerabilities}
                  isRoot
                  firstVulnerabilityId={firstVulnerabilityId}
                  showCode={showCode}
                />
              ))}
            </ul> */}
